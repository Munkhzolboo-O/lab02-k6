...
## 7. 1 Минутийн Pass Fail Stage
And PASS/FAIL:

PASS: 226.66 ms, threshold <350.67 ms
FAIL: 222.5 ms, threshold <1 ms
Stages: 5 → 30 → 100 → 0, p95 241.28 ms
...
1Minute 
Load        VU	      p95	          Throughput	    Error
Low         5	        228 ms	      7.67 req/s	    0.00%
Medium      30	      224.29 ms	    45.94 req/s	    0.00%
High        100	      237.87 ms	    152.07 req/s	  0.00%
